...
export function generateMetadata({ params }) {
  ...
  return {
    title: `${size} Commercial Truck Tires | Compare Retailer Paths`,
    description: `Compare ${size} commercial truck tire options, retailer search paths, commercial fit notes, and quote options.`,
    ...
    <>
      ...
      <section className="section page-shell">
        <div className="section-heading">
          ...
          <p>Main results only include verified {size} commercial tire matches. Confirm load range, casing, position, and application with the retailer or supplier.</p>
        </div>
