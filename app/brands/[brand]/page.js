  ...
  return (
    <>
      ...
      <section className="section page-shell">
        ...
        <p className="fitment-note">Reviewed by the Tire Search Engine editorial team. Updated June 3, 2026. Sources: retailer inventory paths, manufacturer model information, tire sidewall specifications, and the Tire Search Engine methodology.</p>
      </section>
    </>
  );
}
