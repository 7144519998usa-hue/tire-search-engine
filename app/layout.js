    ...
    <html lang="en">
      <body>
        ...
        <Script id="microsoft-clarity" strategy="afterInteractive">
          {`(function(c,l,a,r,i,t,y){var ref=l.referrer||"";var host=l.location&&l.location.hostname?l.location.hostname:"";if(ref.indexOf("vercel.com")!==-1||ref.indexOf("vercel.app")!==-1||host.endsWith(".vercel.app")){return;}c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments);};t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i;y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);})(window,document,"clarity","script","${clarityProjectId}");`}
        </Script>
        <Analytics />
      </body>
    </html>
